  ...
  jobs: [
    ...
    },
    {
      ...
      qualifications: [
        ...
        "Proven experience in software development with modern programming languages.",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Understand client needs and provide tailored solutions and recommendations.",
        ...
        "Collaborate with internal teams to advocate for client needs.",
        "Drive product adoption and identify expansion opportunities.",
        "Gather and communicate client feedback to improve our offerings.",
      ],
      qualifications: [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Stay informed about industry trends and economic factors.",
      ],
      qualifications: [
        ...
        "Strong communication skills with ability to present complex data clearly.",
      ],
      benefits: [
        "Competitive salary based on experience and performance.",
        "Health, dental, and vision insurance coverage.",
